...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _buildLoginForm() {
    return Container(
      padding: EdgeInsets.all(MediaQuery.of(context).size.width > 768 ? 32 : 24),
      decoration: BoxDecoration(
        color: Colors.white,
                        ...
                        children: [
                          // Large logo
                           Image.asset(
                              ...
                              fit: BoxFit.cover,
                                    height: MediaQuery.of(context).size.width > 1024 ? 120 : 100,
                            ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double x = 0; x <= size.width; x += 5) {
      final y = size.height * 0.5 + 
                waveHeight * math.sin(x / waveFrequency) * math.cos(x / (waveFrequency * 1.6));
      path.lineTo(x, y);
    }
