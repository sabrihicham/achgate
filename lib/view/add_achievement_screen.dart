...
class _AddAchievementScreenState extends State<AddAchievementScreen>
          ...
          DropdownButtonFormField<String>(
            ...
            onChanged: (value) {
              setState(() {
                ...
                _selectedMainDepartment = null; // Reset main department selection
                _selectedSubDepartment = null; // Reset sub department selection
                _executiveDepartmentController.text = value ?? '';
                _mainDepartmentController.clear(); // Clear main department field
    ...
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        for (PlatformFile file in result.files) {
          ...
          bool alreadyExists = _selectedFiles.any((existingFile) => 
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final achievementId = await _achievementService.addAchievement(achievement);
